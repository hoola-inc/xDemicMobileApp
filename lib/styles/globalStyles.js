...
export const fontBlack = "Poppins-Black";
export const fontBlackItalic = "Poppins-BlackItalic";
export const fontBold = "Poppins-Bold";
export const fontBoldItalic = "Poppins-BoldItalic";
export const fontExtraBold = "Poppins-ExtraBold";
export const fontExtraBoldItalic = "Poppins-ExtraBoldItalic";
export const fontExtraLight = "Poppins-ExtraLight";
export const fontItalic = "Poppins-Italic";
export const fontExtraLightItalic = "Poppins-ExtraLightItalic";
export const fontLight = "Poppins-Light";
export const fontLightItalic = "Poppins-LightItalic";
export const fontMedium = "Poppins-Medium";
export const fontMediumItalic = "Poppins-MediumItalic";
export const font = "Poppins-Regular";
export const fontSemiBold = "Poppins-SemiBold";
export const fontSemiBoldItalic = "Poppins-SemiBoldItalic";
export const fontThin = "Poppins-Thin";
export const fontThinItalic = "Poppins-ThinItalic";
