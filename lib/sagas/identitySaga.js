...
import { RESET_IDENTITY, CREATE_IDENTITY, CREATE_ACCOUNT } from 'xdemic/lib/constants/UportActionTypes'
import { RESET_DEVICE } from 'xdemic/lib/constants/GlobalActionTypes'
import { currentIdentity } from 'xdemic/lib/selectors/identities'
import { hdAccountIndex, hdRootAddress } from 'xdemic/lib/selectors/hdWallet'
import { storeIdentity, storeSubAccount, removeIdentity, savePublicUport } from 'xdemic/lib/actions/uportActions'
import {
  startWorking, completeProcess
} from 'xdemic/lib/actions/processStatusActions'

// import { push } from 'xdemic/lib/actions/navigatorActions'
// import { setOnboardingNetwork } from 'xdemic/lib/actions/onboardingActions'

import { deviceAddress } from 'xdemic/lib/selectors/chains'
import { seed } from 'xdemic/lib/selectors/recovery'
// import { activationEvents } from 'xdemic/lib/selectors/userActivation'
...
const MNID = require('xdemic/lib/browserified/mnid')
