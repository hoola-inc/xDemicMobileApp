...
import { CLEAR_REQUEST } from 'xdemic/lib/constants/RequestActionTypes'
import { currentAddress, selectedIdentity } from 'xdemic/lib/selectors/identities'
import { currentRequestId, fetchRequest } from 'xdemic/lib/selectors/requests'
import { openExternalUrl } from 'xdemic/lib/helpers/url_handler'
import { storeActivity, updateActivity, openActivity } from 'xdemic/lib/actions/uportActions'
import { saveRequest } from 'xdemic/lib/actions/requestActions'
import { saveError, clearMessage } from 'xdemic/lib/actions/processStatusActions'
...
describe('#findRequestType()', () => {
  ...
  describe('uport urls', () => {
    ;['me.xdemic:', 'https://id.uport.me/'].forEach(protocol => {
...
describe('handleURL()', () => {
  ...
  describe('legacy', () => {
    describe('transaction request', () => {
      it('background', () => {
        const url = 'me.xdemic:2oZqgNx3pzzaT5V6xctreExLz21jVYrh9ef?value=123&callback_url=https://demo.uport.me'
      ...
      describe('callback_type', () => {
        it('post becomes postback=true', () => {
          const url =
            'me.xdemic:2oZqgNx3pzzaT5V6xctreExLz21jVYrh9ef?value=123&callback_url=https://demo.uport.me&callback_type=post'
          const parsed = URL(url, true)
          const request = {
            id: '123131',
            postback: true,
        ...
        it('redirect becomes postback=false', () => {
          const url =
            'me.xdemic:2oZqgNx3pzzaT5V6xctreExLz21jVYrh9ef?value=123&callback_url=https://demo.uport.me&callback_type=redirect'
          const parsed = URL(url, true)
          const request = {
            id: '123131',
            postback: false,
    ...
    describe('selective disclosure', () => {
      it('background', () => {
        const url = 'me.xdemic:me?callback_url=https://demo.uport.me'
        const parsed = URL(url, true)
        const request = {
          id: '123131',
          postback: undefined,
    ...
    describe('add attestations', () => {
      describe('with callback_url', () => {
        const url = 'me.xdemic:add?attestations=JWT&callback_url=https://demo.uport.me'
        const parsed = URL(url, true)
        describe('postback', () => {
          it('background', () => {
            const request = {
      ...
      describe('without callback_url', () => {
        const url = 'me.xdemic:add?attestations=JWT'
        const parsed = URL(url, true)
        it('background', () => {
          const request = {
            id: '123131',
