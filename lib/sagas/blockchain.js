...
// import coder from 'xdemic/lib/browserified/coder'

import { FETCH_NONCE, FETCH_BALANCE, FETCH_FUEL_BALANCE, REFRESH_SETTINGS, FETCH_RECOVERY_NONCE, SWITCH_IDENTITY } from 'xdemic/lib/constants/UportActionTypes'
import { FETCH_GAS_PRICE, ANALYZE_ADDRESS } from 'xdemic/lib/constants/NetworkingActionTypes'

import { saveNonce, saveMetaNonce, saveBalance, saveFuel, storeExternalUport } from 'xdemic/lib/actions/uportActions'
import { saveGasPrice } from 'xdemic/lib/actions/networkingActions'
import {
  startWorking, stopWorking, failProcess, saveMessage
} from 'xdemic/lib/actions/processStatusActions'
import { networks, decodeAddress } from 'xdemic/lib/utilities/networks'
import { identityByAddress } from 'xdemic/lib/selectors/identities'
import { currentNonce, defaultWeb3, web3ForAddress, web3ForNetwork, networkSettingsForAddress, deviceAddressForAddress, txRelayAddressForAddress } from 'xdemic/lib/selectors/chains'
