...
const BASE_URL = "https://xdemic-api.herokuapp.com/schoolwithstudentenroll/";
...
export function fetchSchool(schoolDid) {
  ...
  if (schoolDid)
    return axios.get(`${BASE_URL}schoolwithstudentenroll/${schoolDid}`);
  else return axios.get(`${BASE_URL}schools`);
}
