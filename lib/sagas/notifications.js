...
import { REGISTER_DEVICE_FOR_NOTIFICATIONS, RECEIVE_DEVICE_TOKEN, UPDATE_BADGE_COUNT, INIT_NOTIFICATIONS, SEND_LOCAL_NOTIFICATION, CANCEL_SCHEDULED_NOTIFICATION } from 'xdemic/lib/constants/SnsRegistrationActionTypes'
import { OPEN_ACTIVITY } from 'xdemic/lib/constants/UportActionTypes'
import { storeDeviceToken, storeEndpointArn, skipPushNotifications, handleEncryptedMessage } from 'xdemic/lib/actions/snsRegistrationActions'
