...
import { deviceAddress, deviceAddresses, keychainSecurityLevel, networkSettingsForAddress, isHD } from 'xdemic/lib/selectors/chains'
import {
  hdRootAddress, lastIdentityIndex, lastAccountIndex, hdIdentityIndex, hdAccountIndex
} from 'xdemic/lib/selectors/hdWallet'
import { publicEncKey, currentAddress, currentIdentity } from 'xdemic/lib/selectors/identities'
import { storeIdentity, storeKeyChainLevel, storeSecurityLevel } from 'xdemic/lib/actions/uportActions'
import { storeRootAddress, incIdentityIndex, incAccountIndex } from 'xdemic/lib/actions/HDWalletActions.js'
