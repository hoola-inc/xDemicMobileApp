...
import { publicUportForAddress, ipfsProfile, sharableProfileForAddress } from 'xdemic/lib/selectors/identities'
import { web3ForAddress } from 'xdemic/lib/selectors/chains'
import { working } from 'xdemic/lib/selectors/processStatus'
import { SAVE_PUBLIC_UPORT, REFRESH_EXTERNAL_UPORT, ADD_IMAGE, ADD_IMAGE_ONBOARDING } from 'xdemic/lib/constants/UportActionTypes'
import {
  UPDATE_SHARE_TOKEN
} from 'xdemic/lib/constants/MyInfoActionTypes'

import { addClaims, saveIpfsProfile, storeExternalUport } from 'xdemic/lib/actions/uportActions'
...
import { startWorking, saveMessage, failProcess, completeProcess } from 'xdemic/lib/actions/processStatusActions'
