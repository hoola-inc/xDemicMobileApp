...
// Selectors
import { notifications, notificationCount } from 'xdemic/lib/selectors/activities'
import { externalProfile } from 'xdemic/lib/selectors/requests'
import { requestedClaims } from 'xdemic/lib/selectors/attestations'

// Actions
import { authorizeRequest, cancelRequest, selectRequest } from 'xdemic/lib/actions/requestActions'
import { openActivity } from 'xdemic/lib/actions/uportActions'
