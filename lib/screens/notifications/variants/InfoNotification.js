...
import { Button } from "xdemic/lib/components/shared/Button";
...
const InformationNotification = props => {
  ...
  const client =
    props.issuer(props.activity.client_id) || Images.profile.avatar;
  ...
  return (
    <View style={styles.notificationContainer}>
      <View style={styles.cardContainer}>
        ...
        <Text style={styles.cardTitle}>{props.activity.title}</Text>
        <Text style={styles.cardBody}>{props.activity.body}</Text>
        <Button
          onPress={handleCta}
          style={{ borderColor: colors.brand, borderWidth: 1 }}
        >
