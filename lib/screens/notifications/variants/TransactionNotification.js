...
import DataFlowHeader from "xdemic/lib/components/Request/partials/DataFlowHeader";
      ...
      <Text style={[textStyles.h2, { margin: 10 }]}>
        {props.activity.canceledAt
          ...
          ? props.activity.authorizedAt
            ? "You updated your public xDemic profile"
            : "Updating your public xDemic profile"
