...
export function registerScreens(redux: any) {
  ...
  registerComponentWithRedux(redux)(SCREENS.SendTo, require('./share/Share').default)
  registerComponentWithRedux(redux)(SCREENS.Share, require('./share/SendTo').default)
  ...
  registerComponentWithRedux(redux)(SCREENS.AddSchoolInformation, require('./onboarding/AddSchoolInformation').default)
