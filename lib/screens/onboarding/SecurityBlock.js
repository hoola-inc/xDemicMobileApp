...
import { onboardingStyles, textStyles } from "xdemic/lib/styles/globalStyles";
    ...
    return (
      ...
      >
        ...
        <Text style={[textStyles.p, styles.message]}>
          xDemic ID requires that your device is protected by a pin or password.
        </Text>
        <Text style={[textStyles.p, styles.message]}>
          Navigate to the security settings for your device and set one to
          continue.
        </Text>
      </ProcessCard>
    );
