...
import { Images, Text, Icon, Card, Container, Colors, Theme } from "@kancha";
      ...
      >
        <Card borderLeft={expandable}>
          <AvatarNameWithSubHeader
            ...
            schoolName={name}
            schoolPosition={email}
          />

          <CardItem
            style={{
              paddingLeft: Theme.spacing.default28,
              paddingRight: Theme.spacing.default32
            }}
          >
            <DataCard
              {...this.props}
