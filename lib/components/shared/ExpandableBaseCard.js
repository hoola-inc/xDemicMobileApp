...
import { Theme, Icon, Container } from "@kancha";
          ...
          <Card style={Styles.cardStyle}>
            <CardItem style={Styles.cardCourseName}>
              <Container flexDirection={"row"}>
                ...
                <Container padding>
                  <Text style={Styles.cardCourseNameText}>
                    Expendable 1 {courseName}
                  </Text>
                  <Text style={Styles.cardCourseNameText}>{schoolName}</Text>
                </Container>
                <Container padding>
                  <Icon
                    name={"heart"}
