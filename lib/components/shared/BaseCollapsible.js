...
export default class BaseCollapsible extends Component {
  ...
  toggleExpanded = () => {
    ...
    const { activeBorder, collapsed, isLongPressEnable } = this.state;
    // if(activeBorder){
    this.setState({
      collapsed: !collapsed,
      activeBorder: isLongPressEnable ? true : !collapsed ? !activeBorder : true
    });
    // }
  };
  ...
  render() {
    ...
    return (
      <Container marginBottom={Theme.spacing.default}>
        <Card
          borderLeft={this.state.activeBorder}
          onLongPress={() => {
            console.log("BaseCollapsible onLongPress is calling!");
            this.setState({
              activeBorder: !this.state.activeBorder,
              isLongPressEnable: !this.state.isLongPressEnable
            });
            // !this.state.collapsed;
          }}
          onPress={() => console.log("BaseCollapsible onPress is calling!")}
        >
