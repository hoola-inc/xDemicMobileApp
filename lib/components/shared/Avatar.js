...
// Utilities
import { getInitials } from "xdemic/lib/utilities/getInitials";

// Styles
import { font, colors } from "xdemic/lib/styles/globalStyles";

// Constants
const anon = require("xdemic/assets/images/default_profile_image.png");
  ...
  >
    <Text
      style={[
        styles.initials,
        props.initialsStyle,
        { fontSize: (props.size || defaultSize) / 3 }
      ]}
    >
      {props.text}
    </Text>
    ...
    <View>
      {props.source ? (
        props.source.avatar ? (
          ...
          <Thumbnail
            size={props.size || defaultSize}
            source={require("xdemic/assets/images/ethereum-white-icon.png")}
            borderColor={props.borderColor}
            borderWidth={props.borderWidth}
            style={[avatarSize(props), props.style]}
          >
