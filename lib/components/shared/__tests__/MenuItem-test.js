...
it("renders MenuItem with title", () => {
  const tree = renderer.create(<MenuItem title="hello" />).toJSON();
  expect(tree).toMatchSnapshot();
});

it("renders MenuItem with title and value", () => {
  const tree = renderer
    .create(<MenuItem title="hello" value="stuff" />)
    .toJSON();
  expect(tree).toMatchSnapshot();
});
...
it("renders MenuItem with title and link", () => {
  const tree = renderer
    .create(<MenuItem title="hello" href="http://demo.uport.me" />)
    .toJSON();
  expect(tree).toMatchSnapshot();
});
...
it("renders MenuItem with title and onPress", () => {
  const tree = renderer
    .create(<MenuItem title="hello" onPress={() => console.log("hello")} />)
    .toJSON();
  expect(tree).toMatchSnapshot();
});
