...
class ExpandableCollapsiableCard extends Component {
  constructor(props) {
    super(props);
    this.state = {
      map: props.data || true
  ...
  render() {
    ...
    console.log("ExpandableCollapsiableCard props is: ", this.props.data);
    return (
      <Card>
...
ExpandableCollapsiableCard.propTypes = {
  data: PropTypes.object
};

export default ExpandableCollapsiableCard;
