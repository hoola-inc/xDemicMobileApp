...
export const trafficAccidentClaim = {
  ...
  vehicleA: {
    ...
    visibleDamageToVehicleA: ["Right front door", "Right rear wheel"],
    ...
    circumstances: ["Parked", "Opening the door"],
